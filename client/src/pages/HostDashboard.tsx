      ...
      <footer className="bg-gray-50 border-t border-gray-200 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Host Resources */}
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-4">Host Resources</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Host Guide</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Safety Center</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Community Standards</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Host Academy</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Host Community</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Report an Issue</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Host Agreement</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Cancellation Policy</a></li>
              </ul>
            </div>
            
            {/* Company */}
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-4">TVHStays</h3>
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Investor Relations</a></li>
              </ul>
            </div>
          </div>
